...
SECRET_KEY = 'tp!xzu0d56!tz164p2wl7olh51k!wq!2e9uapbcy-b_8g3yg3x'
...
DATABASES = {
    'default': {
        ...
        'NAME': # Enter Your Data Base 
        'USER': # Enter Your Data base user
        'PASSWORD': # Enter Your Data base Password
